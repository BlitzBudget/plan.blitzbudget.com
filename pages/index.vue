      ...
      <div class="row justify-content-center text-center">
        <div class="col-md-6">
          ...
          <p class="lead text-white">
            Argon is a completly new product built on our newest re-built from scratch framework structure that is meant
            to make our products more intuitive,
            more adaptive and, needless to say, so much easier to customize. Let Argon amaze you with its cool features
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              ...
              <a href="https://nucleoapp.com/?ref=1712" target="_blank" rel="noopener"
        ...
        <div class="row row-grid justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <p class="lead">Cause if you do, it can be yours now. Hit the button below to navigate to get the free
              ...
              a new look!</p>
            <div class="btn-wrapper">
              <a href="https://www.creative-tim.com/product/nuxt-argon-dashboard?ref=nvadp-index-page"
                class="btn btn-neutral mb-3 mb-sm-0" target="_blank" rel="noopener">
                <span class="btn-inner--text">Get FREE version</span>
              </a>
              <a href="https://www.creative-tim.com/product/nuxt-argon-dashboard-pro?ref=vadp-index-page"
              ...
              <div class="row justify-content-center">
                <div class="col-md-2 col-3 my-2">
                  <el-tooltip placement="top" content="Bootstrap 4 - Most popular front-end component library">
                    <a href="https://www.creative-tim.com/product/argon-dashboard?ref=nvadp-index-page" target="_blank"
                      rel="noopener" aria-label="Bootstrap">
                      <img
                        src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/bootstrap.jpg"
                        class="img-fluid rounded-circle shadow shadow-lg--hover" alt="Bootstrap image">
                    </a>
                  </el-tooltip>
                </div>
                <div class="col-md-2 col-3 my-2">
                  ...
                  <el-tooltip placement="top" content="[Coming Soon] Sketch - Digital design toolkit">
                    <a href=" https://www.sketchapp.com/" target="_blank" rel="noopener" aria-label="Sketch">
                      <img
                        ...
                        class="img-fluid rounded-circle opacity-3" alt="Sketch logo">
                    </a>
                  </el-tooltip>
                </div>
                <div class="col-md-2 col-3 my-2">
                  <el-tooltip placement="top"
                    content="[Coming Soon] Adobe Photoshop - Software for digital images manipulation">
                    <a href=" https://www.adobe.com/products/photoshop.html" target="_blank" rel="noopener"
                      ...
                      <img src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/ps.jpg"
                        class="img-fluid rounded-circle opacity-3" alt="Photoshop logo">
                    </a>
                  </el-tooltip>
                </div>
                <div class="col-md-2 col-3 my-2">
                  <el-tooltip placement="top" content="Angular - One framework. Mobile ">
                    <a href="https://www.creative-tim.com/product/argon-dashboard-angular?ref=nvadp-index-page"
                      target="_blank" rel="noopener" aria-label="Angular">
                      <img
                        src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/angular.jpg"
                        class="img-fluid rounded-circle" alt="Angular logo">
                    </a>
                  </el-tooltip>
                </div>
                <div class="col-md-2 col-3 my-2">
                  <el-tooltip placement="top" content="React - A JavaScript library for building user interfaces">
                    <a href="https://www.creative-tim.com/product/argon-dashboard-react?ref=nvadp-index-page"
                      target="_blank" rel="noopener" aria-label="React">
                      <img
                        src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/react.jpg"
                        class="img-fluid rounded-circle" alt="React logo">
                    </a>
                  </el-tooltip>
                </div>
              </div>
